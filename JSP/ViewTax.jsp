...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">View Tax</a>
    </div>
...
<div class="header"><span class="textHeader">View Tax</span></div>

		<div class="form-group">
			<br> <br> View Tax Of Year: ${selectedYear} is
			${sumofSelectedYearTaxes}
			<s:form action="/yearlyTaxForm" method="post">
				<s:textfield name="selectedYear" key="label.year" cssClass="txtField"/>
				<s:submit method="execute" key="label.view" align="center"
					class="submitBtn" />
			</s:form>
			<br>
			<div class="error">
