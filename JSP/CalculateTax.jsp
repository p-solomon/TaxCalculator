...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    <div class="navbar-header">
      <a class="navbar-brand" href="#">Calculate Tax</a>
    </div>
...
<div class="header"><span class="textHeader">Calculate Tax</span></div>

		<s:form action="/addCalculatedTax" method="post">
			...
			<div class="form-group">
				<s:textfield name="year" key="label.year" cssClass="txtField" />
			</div>

			<div class="form-group">
				<s:textfield name="grossSalary" key="label.salary" cssClass="txtField" />
			</div>

			<div class="form-group">
				<s:submit method="execute" key="label.calculate" align="center"
					class="submitBtn" />
			</div>
