...
<div class="header"><span class="textHeader">Add Employee</span></div>

		<s:form action="/addEmployeeForm" method="post">
			<div class="form-group">
				<s:textfield name="name" key="label.username" cssClass="txtField" />
			</div>
			<div class="form-group">
				<s:textfield name="staffNumber" key="label.staffnumber" cssClass="txtField" />
			</div>
			<div class="form-group">
				<s:textfield name="ppsNumber" key="label.ppsnumber" cssClass="txtField" />
			</div>
			<div class="form-group">
				<s:submit method="execute" key="label.add" class="submitBtn" />
			</div>
		</s:form>
		<div class="error">
			<s:actionerror />
